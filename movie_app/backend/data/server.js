...
const sandwiches = [
  ...
  { id: 10, title: 'Churros Sandwich', cafeLocation: 'Convenience Store', summary: 'Indulge in a sweet and savory experience with Convenience Store\'s Churros Sandwich. This unique creation combines the beloved churros with a savory twist, creating a delightful fusion of flavors.', poster: '/sandwich-images/Churros.jpg', ingredients: ['churros', 'chocolate', 'cream', 'bread'], rating: '3.9' },
  { id: 11, title: 'Rice Sandwich', cafeLocation: 'Eun Koo Homemade', summary: 'Experience a taste of Asia with Eun Koo Homemade\'s Rice Sandwich. This unique creation features a medley of ingredients sandwiched between layers of rice, creating a delightful and satisfying meal.', poster: '/sandwich-images/RiceSando.jpg', ingredients: ['rice', 'cucumber', 'ham', 'soy sauce'], rating: '3.7' },
  { id: 12, title: 'Reuben Sandwich', cafeLocation: 'Salt House', summary: 'Savor the classic flavors of Salt House\'s Reuben Sandwich. With a perfect blend of ingredients, this sandwich is a tribute to the timeless tradition of a delicious and hearty meal.', poster: '/sandwich-images/SaltHouse.jpg', ingredients: ['ham', 'bread', 'tomato', 'mayo'], rating: '4.0' },
  { id: 13, title: 'Gatsu Sando', cafeLocation: 'Cafe Sando', summary: 'Embark on a gastronomic adventure with Cafe Sando\'s Gatsu Sando. This Japanese-inspired sandwich features a delightful combination of flavors, offering a unique and satisfying experience.', poster: '/sandwich-images/gatsuSando.jpg', ingredients: ['fried meat', 'bread'], rating: '4.7' },
...
const comments = {
  ...
  "3": [
    { id: 4, text: "Wanna go there!"}
  ],
  "4": [
    { id: 5, text: "Makes me feel hungry!"}
  ],
  "5": [
    { id: 6, text: "Yummy yummy"}
  ],
  "6": [
    { id: 7, text: "Lekker"}
  ],
  ...
  "10": [
    { id: 11, text: "Wow it looks so good"}
  ],
  "11": [
    { id: 12, text: "맛있겠다!"}
  ],
  ...
  "13": [
    { id: 14, text: "Hey im gonna go there tmr"}
  ],
  "14": [
    { id: 15, text: "Baam!"}
  ],
  "15": [
    { id: 16, text: "You are amazing"}
  ],
  "16": [
    { id: 17, text: "Baam!"}
  ],
